...
- (void)viewDidLoad
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        // Group enumerator Block
            ...
            // Enumerate Albums
            [[AppDelegate defaultAssetsLibrary] enumerateGroupsWithTypes:ALAssetsGroupAll
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ELCImagePickerController *nParent = (ELCImagePickerController*)self.parent;
    nParent.assetGroup = [self.assetGroups objectAtIndex:indexPath.row];
    [nParent selectCameraRoll];
}
